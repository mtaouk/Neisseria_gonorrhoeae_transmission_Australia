...
# 1. Prepare Schema
cd /home/taouk/NGtransmission/cgMLST/Schemes
...
iqtree -s 5881.full.aln -B 1000 -T 40

# 3. Snp distance matrix including callibration isolates
...
- FIGURES
- all results and all intermediate files

- cgMLST_alignment.sh
- cgMLST_alignment_part1.r
- split.sh
- trees.sh
- dates.sh
- BEAST script
